...
type LayoutRouteId = RouteId | "/(protected)/admin" | "/(protected)/admin/organizations" | "/(protected)/admin/settings" | "/(protected)/admin/settings/account" | "/(protected)/admin/settings/api-keys" | "/(protected)/admin/settings/members" | "/(protected)/admin/settings/plugins" | "/(protected)/admin/settings/roles"
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(protected)/admin/+page.server.js').load>>>>>>;
