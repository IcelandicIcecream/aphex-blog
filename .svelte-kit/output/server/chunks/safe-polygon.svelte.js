import { af as hasContext, g as getContext, s as setContext, f as derived, ag as getAllContexts, l as spread_props } from "./renderer.js";
import "clsx";
import { n as isWritableSymbol, B as BoxSymbol, o as boxFrom, b as boxWith, p as boxFlatten, t as toReadonlyBox, q as isBox, r as isWritableBox, u as isObject, d as createBitsAttrs, a as attachRef, k as getDataOpenClosed, f as boolToEmptyStrOrUndef, g as boolToStr, l as getDataTransitionAttrs, m as mergeProps, v as executeCallbacks, w as simpleBox, x as composeHandlers, y as cssToStyleObj, s as styleToString } from "./create-id.js";
  ...
  constructor(opts) {
    ...
    watch([opts.triggerNode, opts.contentNode, opts.enabled], ([triggerNode, contentNode, enabled]) => {
      ...
      const handleTriggerLeave = (e) => {
        ...
        if (isElement$1(target) && ignoredTargets.some((n2) => n2 === target || n2.contains(target))) {
          return;
        }
        this.#transitTargets = isElement$1(target) && ignoredTargets.length > 0 ? ignoredTargets.filter((n2) => target.contains(n2)) : [];
...
export {
  ...
  DOMContext as D,
  ENTER as E,
  FloatingAnchorState as F,
  resolvePreviewTitle as G,
  HOME as H,
  getFirstNonCommentChild as I,
  ARROW_LEFT as J,
  h as K,
  k as L,
  p as M,
  ...
  isTabbable as Y,
  useId as Z,
  resolvePreviewSubtitle as _,
  Focus_scope as a,
  MenuItemState as a0,
  MenuSeparatorState as a1,
  MenuRootState as a2,
  MenuMenuState as a3,
  MenuContentState as a4,
  DropdownMenuTriggerState as a5,
  FloatingArrowState as a6,
  isFocusVisible as a7,
  unmount as a8,
  mount as a9,
  afterSleep as b,
  Escape_layer as c,
