import { f as derived, u as props_id, h as attributes, j as bind_props, b as attr, l as spread_props, i as clsx, c as attr_class, e as escape_html, ah as await_block, d as stringify, s as setContext, g as getContext } from "./renderer.js";
import { c as cn } from "./utils2.js";
import { tv } from "tailwind-variants";
import { C as Context, j as PresenceManager, w as watch, S as SPACE$1, E as ENTER, Z as useId, a6 as FloatingArrowState, n as noop$1, a as Focus_scope, c as Escape_layer, d as Dismissible_layer, T as Text_selection_layer, e as Scroll_lock, D as DOMContext, X as isElement, a7 as isFocusVisible, W as SafePolygon, B as Floating_layer, y as Popper_layer_force_mount, z as Popper_layer, v as getFloatingContentCSSVars, P as Portal, G as resolvePreviewTitle, _ as resolvePreviewSubtitle, a8 as unmount, a9 as mount } from "./safe-polygon.svelte.js";
import { I as Icon } from "./Icon.js";
import { c as assets } from "./instance2.js";
import "clsx";
import { b as boxWith, k as getDataOpenClosed, a as attachRef, l as getDataTransitionAttrs, f as boolToEmptyStrOrUndef, d as createBitsAttrs, g as boolToStr, e as createId, m as mergeProps, w as simpleBox } from "./create-id.js";
import { M as MediaQuery } from "./index-server.js";
...
function PortableTextImageView($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attr_class("image-block-view group svelte-1c0cuiq", void 0, { "selected": selected })} data-pt-image-edit="">`);
    if (assetPromise()) {
      $$renderer2.push("<!--[0-->");
      await_block(
        $$renderer2,
        assetPromise(),
        () => {
          $$renderer2.push(`<div class="image-block-placeholder svelte-1c0cuiq"><div class="border-primary h-5 w-5 animate-spin rounded-full border-2 border-t-transparent"></div></div>`);
        },
        (result) => {
          if (result.success && result.data?.url) {
            $$renderer2.push("<!--[0-->");
            $$renderer2.push(`<img${attr("src", result.data.url)}${attr("alt", data?.alt || "")} class="image-block-img svelte-1c0cuiq"/>`);
          } else {
            $$renderer2.push("<!--[-1-->");
            $$renderer2.push(`<div class="image-block-placeholder svelte-1c0cuiq">`);
    ...
    $$renderer2.push(`<!--]--> <div class="image-block-actions svelte-1c0cuiq"><button type="button" class="text-muted-foreground hover:text-destructive rounded p-1 transition-colors" title="Remove">`);
    Trash_2($$renderer2, { class: "h-3.5 w-3.5" });
    $$renderer2.push(`<!----></button></div></div>`);
  });
}
...
function PortableTextInlineView($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<span${attr_class("inline-object-chip svelte-14elxam", void 0, { "selected": selected })}${attr("title", `Edit ${stringify(type)}`)} role="button" tabindex="0"><span class="inline-object-type svelte-14elxam">${escape_html(type.slice(0, 2).toUpperCase())}</span> <span class="inline-object-label svelte-14elxam">${escape_html(label())}</span> <button class="inline-object-delete svelte-14elxam" title="Remove">×</button></span>`);
  });
}
...
export {
  ...
  Dialog_content as e,
  Dialog_close as f,
  DialogActionState as g,
  AlertDialogCancelState as h,
  DialogContentState as i,
  Provider as j,
  SIDEBAR_COOKIE_NAME as k,
  SIDEBAR_COOKIE_MAX_AGE as l,
  SIDEBAR_WIDTH as m,
  SIDEBAR_WIDTH_ICON as n,
  SIDEBAR_WIDTH_MOBILE as o,
  Sidebar_menu_button as p,
  setSidebar as s,
  useSidebar as u
};
