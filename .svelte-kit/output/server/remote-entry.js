import { S as noop, b as parse, c as unfriendly_hydratable, i as parse_remote_arg, o as stringify, r as create_remote_key, s as stringify_remote_arg } from "./chunks/shared.js";
import { r as base, t as app_dir } from "./chunks/server.js";
import { _ as deep_set, b as normalize_issue, g as create_field_proxy, o as handle_error_and_jsonify, w as MUTATIVE_METHODS, x as set_nested_value, y as flatten_issues } from "./chunks/utils.js";
...
//#region ../../node_modules/.pnpm/@sveltejs+kit@2.59.1_@opentelemetry+api@1.9.0_@sveltejs+vite-plugin-svelte@7.2.0_svelte_b04ba523657186a84b6a74c1243122db/node_modules/@sveltejs/kit/src/runtime/app/server/remote/shared.js
...
//#endregion
//#region ../../node_modules/.pnpm/@sveltejs+kit@2.59.1_@opentelemetry+api@1.9.0_@sveltejs+vite-plugin-svelte@7.2.0_svelte_b04ba523657186a84b6a74c1243122db/node_modules/@sveltejs/kit/src/runtime/app/server/remote/command.js
...
//#endregion
//#region ../../node_modules/.pnpm/@sveltejs+kit@2.59.1_@opentelemetry+api@1.9.0_@sveltejs+vite-plugin-svelte@7.2.0_svelte_b04ba523657186a84b6a74c1243122db/node_modules/@sveltejs/kit/src/runtime/app/server/remote/form.js
...
//#endregion
//#region ../../node_modules/.pnpm/@sveltejs+kit@2.59.1_@opentelemetry+api@1.9.0_@sveltejs+vite-plugin-svelte@7.2.0_svelte_b04ba523657186a84b6a74c1243122db/node_modules/@sveltejs/kit/src/runtime/app/server/remote/prerender.js
...
//#endregion
//#region ../../node_modules/.pnpm/@sveltejs+kit@2.59.1_@opentelemetry+api@1.9.0_@sveltejs+vite-plugin-svelte@7.2.0_svelte_b04ba523657186a84b6a74c1243122db/node_modules/@sveltejs/kit/src/runtime/app/server/remote/query.js
...
function query(validate_or_fn, maybe_fn) {
	...
	const wrapper = (arg) => {
		...
		const { event, state } = get_request_store();
		const payload = stringify_remote_arg(arg, state.transport);
		return create_query_resource(__, payload, state, () => run_remote_function(event, state, false, () => validate(arg), fn));
	};
	Object.defineProperty(wrapper, "__", { value: __ });
	return wrapper;
}
...
function live(validate_or_fn, maybe_fn) {
	...
	*/
	...
	const wrapper = (arg) => {
		...
		const { event, state } = get_request_store();
		const payload = stringify_remote_arg(arg, state.transport);
		return create_live_query_resource(__, payload, state, () => first_value(run(event, state, () => validate(arg))));
	};
	Object.defineProperty(wrapper, "__", { value: __ });
	return wrapper;
}
...
//#endregion
//#region ../../node_modules/.pnpm/@sveltejs+kit@2.59.1_@opentelemetry+api@1.9.0_@sveltejs+vite-plugin-svelte@7.2.0_svelte_b04ba523657186a84b6a74c1243122db/node_modules/@sveltejs/kit/src/runtime/app/server/remote/requested.js
