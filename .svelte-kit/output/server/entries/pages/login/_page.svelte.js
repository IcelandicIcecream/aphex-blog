import { m as head, e as escape_html, b as attr } from "../../../chunks/renderer.js";
                ...
                children: ($$renderer5) => {
                  {
                    ...
                    if (error) {
                      $$renderer5.push("<!--[0-->");
                      $$renderer5.push(`<div class="border-destructive/50 bg-destructive/10 space-y-2 rounded-lg border p-3"><p class="text-destructive text-sm font-medium">${escape_html(error)}</p> `);
                      if (unverifiedEmail) {
                        $$renderer5.push("<!--[0-->");
                        $$renderer5.push(`<button type="button" class="text-primary text-xs font-medium hover:underline disabled:opacity-50"${attr("disabled", resendCooldown > 0, true)}>`);
                        {
                          $$renderer5.push("<!--[-1-->");
                          $$renderer5.push(`Resend verification email`);
                        }
                    ...
                    if (resendMessage) {
                      $$renderer5.push("<!--[0-->");
                      $$renderer5.push(`<div class="bg-muted/50 rounded-lg border p-3"><p class="text-muted-foreground text-sm">${escape_html(resendMessage)}</p></div>`);
                    } else {
                      $$renderer5.push("<!--[-1-->");
                    }
                    ...
                    if (emailLocked) {
                      $$renderer5.push("<!--[0-->");
                      $$renderer5.push(`<p class="text-muted-foreground text-xs">Locked to match your invitation.</p>`);
                    } else {
                      $$renderer5.push("<!--[-1-->");
                    }
                    $$renderer5.push(`<!--]--></div> `);
